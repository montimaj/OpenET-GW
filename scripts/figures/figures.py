...
for year in years:
    ...
    q1 = np.percentile(yearly_df.pumping_net_et_factor_annual, 25)
    q3 = np.percentile(yearly_df.pumping_net_et_factor_annual, 75)
    iqr = q3 - q1
    ll = q1 - 1.5 * iqr
    if ll < 0:
        ll = np.min(yearly_df.pumping_net_et_factor_annual)
    ul = q3 + 1.5 * iqr
...
dv_data = df[df.pumping_net_et_factor_annual < ul]
dv_data = dv_data[dv_data.pumping_net_et_factor_annual > ll]
...
plt.savefig("with_lower_filter/dv_model_scatter_plot.png", bbox_inches='tight', dpi=400)
# #
# #
# # # ################################################################
...
# plt.xlim(-0.1, 1.75)
#
# plt.savefig(r"with_lower_filter/dv_model_volume_scatter_plot.png", bbox_inches='tight', dpi=400)
#
#
# ###############################################################
...
# # plt.xlim(0, 2.5)
# #
# # plt.savefig(r"with_lower_filter/dv_ratio_hist_plot.png", bbox_inches='tight', dpi=400)
# # plt.clf()
# sns.boxplot(y=df['pumping_net_et_factor_annual'], x='year', data=df)
# plt.ylim(-0.3, 3)
# plt.axhline(y=0.7, color='r', linestyle='--', linewidth=0.01)
# plt.axhline(y=1.5, color='r', linestyle='--', linewidth=0.01)
# plt.xticks(fontsize=16)
# plt.yticks(fontsize=16)
#
...
#
# # Outlier data
# dv_data = df.loc[df['pumping_net_et_factor_annual']<ul, :]
# dv_data = dv_data.loc[dv_data['pumping_net_et_factor_annual']>ll, :]
# dv_data = dv_data[dv_data["pumping_mm"] > 0]
# data_column = 'annual_net_et_mm'
#
# # Separeate X and y data
...
# plt.yticks(fontsize=16)
#
# plt.xlabel("Standardized Residuals (Diamond Valley)", fontsize=18)
# plt.ylabel("Frequency", fontsize=18)
# # plt.title("Diamond Valley", fontsize=20)
#
# plt.savefig(r"with_lower_filter/dv_model_std_residual_histogram_plot.png", bbox_inches='tight', dpi=400)
#
#
# ###############################################################
...
# # plt.title("Diamond Valley", fontsize=20)
#
# plt.savefig(r"with_lower_filter/dv_model_std_residual_scatter_plot.png", bbox_inches='tight', dpi=400)
#
#
# # ################################################################
...
print('HB LL/UL:', ll, ul)

df = df[df.pumping_net_et_factor_annual < ul]
df = df[df.pumping_net_et_factor_annual > ll]
print(n, df.shape[0])
...
plt.savefig("with_lower_filter/hb_model_scatter_plot.png", bbox_inches='tight', dpi=400)
# #
# #
# # # ################################################################
...
# plt.xlim(-0.01, 0.9)
#
# plt.savefig(r"with_lower_filter/hb_model_volume_scatter_plot.png", bbox_inches='tight', dpi=400)
#
#
# ################################################################
...
df = df[~df.fid.isin(['15', '533_1102', '1210_1211', '1329', '1539_1549_1550', '1692'])]
df = df[df["pumping_mm"] > 0]
df = df.loc[df['pumping_net_et_factor_annual']<ul, :]
df = df.loc[df['pumping_net_et_factor_annual']>ll, :]
...
plt.xlabel("Standardized Residuals (Harney Basin)", fontsize=18)
plt.ylabel("Frequency", fontsize=18)
# plt.title("Harney Basin", fontsize=20)

plt.savefig(r"with_lower_filter/hb_std_residual_histogram_plot.png", bbox_inches='tight', dpi=400)
#
#
# ################################################################
...
# # plt.title("Harney Basin", fontsize=20)
#
# plt.savefig(r"with_lower_filter/hb_model_std_residual_scatter_plot.png", bbox_inches='tight', dpi=400)
#
#
#
# # ################################################################
...
# plt.legend()
#
# plt.savefig('with_lower_filter/hb_bar_plot.png', bbox_inches='tight', dpi=400)
