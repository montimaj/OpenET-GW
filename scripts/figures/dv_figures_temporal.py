...
for et_var in et_vars.keys():
    ...
    dv_train = dv_data[dv_data['year'].isin(train_years)]
    dv_test = dv_data[dv_data['year'].isin(test_years)]
    x_train = np.array(dv_train[data_column])
    y_train = np.array(dv_train['pumping_mm'])
    x_test = np.array(dv_test[data_column])
    y_test = np.array(dv_test['pumping_mm'])
    ...
    plt.savefig(f"temporal/{t_type}/dv_model_scatter_plot_train_{et_var}_intercept_{fit_intercept}.png", bbox_inches='tight', dpi=600)
    ...
    plt.savefig(f"temporal/{t_type}/dv_model_std_residual_histogram_plot_train_{et_var}.png", bbox_inches='tight', dpi=600)
    ...
    plt.savefig(f"temporal/{t_type}/dv_model_scatter_plot_test_{et_var}_intercept_{fit_intercept}.png", bbox_inches='tight', dpi=600)
    ...
    plt.savefig(f"temporal/{t_type}/dv_model_std_residual_histogram_plot_{et_var}_test.png", bbox_inches='tight', dpi=600)
    ...
    plt.savefig(f"temporal/{t_type}/dv_model_std_residual_scatter_plot_{et_var}_test.png", bbox_inches='tight', dpi=600)
